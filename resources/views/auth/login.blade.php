...
<head>
    ...
    <title>Login - {{ config('app.name', 'FitNexus') }}</title>
    @viteReactRefresh
...
<nav class="navbar">
  ...
  <div class="nav-right">
    ...
    <a href="{{ route('login') }}" class="nav-link" style="color: var(--neon-cyan);">Login</a>
  </div>
</nav>
...
<div class="main-content">
  ...
  <div class="hero-text">
    ...
    <h1 class="hero-title">Welcome <span class="highlight">Back</span></h1>
    <p class="hero-subtitle">Log in to continue your fitness journey</p>
  </div>
